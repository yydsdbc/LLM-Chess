...
(function (root) {
  ...
  var ZH = {
    ...
    think_total: '总思考 {n}s',
    think_stat_tpl: '{t}s·{m}手·{p}',   // 第40轮漏挂回补: 面板 stat 原拼接裸中文 '手' → EN 界面显示 "11s·11手·1s/手"
    think_per_move: '{s}s/手',
    badge_quick: '⚡快答',
    d_conf: '信',
    d_more: '…更早 {n} 条决策',
    ...
    status_limit: ' · 限着 {n}/120',
    status_retry_wait: ' · 重试{n}次(待{s}s)',   // 第40轮漏挂回补: 第38轮 waitMs 分支引用此键但字典从未收录 → 状态条原样显示 'status_retry_wait'
    phase_opening: '开局', phase_middlegame: '中局', phase_endgame: '残局',
    res_stalemate: '困毙 · 对方无子可动且未被将军',
    res_checkmate: '绝杀 · 对方无合法应将走法',
    res_perpetual: '长将判负 · 一方连续将军不变招',
    res_repetition: '三次重复判和 · 同一局面反复出现, 双方不变招',
    res_natural: '自然限着判和 · 双方 60 回合无吃子',
    summary_none: '(无摘要)',
    board_label: '棋盘',
    ...
    rp_prevcap: '⏪吃', rp_nextcap: '吃子⏩', overlay_close: '关闭',
    rp_nextrecord_title: '下一局', rp_export_pgn_title: '导出 PGN',
    rp_help_title: '键盘帮助 (?)', rp_full_title: '全屏模式 (F)', rp_exit_full_title: '退出全屏 (F/Esc)',
    rp_pick_label: '选择棋谱', rp_jump_input_label: '跳转到指定手数', rp_go: '跳转',
    rp_mk_mate: '杀', rp_mk_stuck: '困', rp_mk_check: '将',
    ...
    rp_jump_max: '跳到最长思考那一手 (#{n})',
    status_turn_red: '当前回合：红方',
    ...
    multi_council: '会诊 (并行投票)', multi_roundtable: '圆桌 (互看再投票)',
    ...
    undo_tip: '↩ 悔棋 (快捷键 U)',
    help_main_title: '⌨️ 快捷键', help_arrows: '方向键: 移动棋盘光标', help_enter: 'Enter / Space: 选子 / 走子', help_esc: 'Esc: 取消 / 关闭',
    help_u: 'U: 悔棋', help_m: 'M: 静音', help_r: 'R: 重开 (确认)', help_f: 'F: 全屏观战', help_q: '? / /: 本帮助', help_drag: '棋子可直接拖拽走子; 拖拽可在设置中关闭。',
  ...
  var EN = {
    ...
    agent_fail: 'Failed: {m}',
    ai_elapsed: 'Elapsed {t}',
    tray_captured: 'Cap',
    log_entry_title: 'Click to jump to move {n}',
    think_total: 'Total think {n}s',
    think_stat_tpl: '{t}s·{m} moves·{p}',
    think_per_move: '{s}s/move',
    badge_quick: '⚡Quick',
    d_conf: 'conf',
    ...
    status_limit: ' · {n}/120 limit',
    status_retry_wait: ' · {n} retries (waiting {s}s)',
    phase_opening: 'Opening', phase_middlegame: 'Middlegame', phase_endgame: 'Endgame',
    res_stalemate: 'Stalemate · opponent has no legal move and is not in check',
    res_checkmate: 'Checkmate · opponent has no legal reply',
    res_perpetual: 'Loss by perpetual check · one side keeps checking without varying',
    res_repetition: 'Draw by threefold repetition · the same position recurs, neither side varies',
    res_natural: 'Draw by the 60-move rule · no capture for 60 moves',
    summary_none: '(no summary)',
    board_label: 'Board',
    ...
    rp_prevcap: '⏪ Cap', rp_nextcap: 'Cap ⏩', overlay_close: 'Close',
    ...
    rp_pick_label: 'Select game record', rp_jump_input_label: 'Jump to move number', rp_go: 'Go',
    rp_mk_mate: 'Mate', rp_mk_stuck: 'Stuck', rp_mk_check: 'Check',
    ...
    rp_jump_max: 'Jump to the longest-think move (#{n})',
    status_turn_red: 'Turn: Red',
    ...
    multi_council: 'Council (parallel vote)', multi_roundtable: 'Roundtable (see & revote)',
    ...
    help_main_title: '⌨️ Shortcuts', help_arrows: 'Arrows: move the board cursor', help_enter: 'Enter / Space: select & move', help_esc: 'Esc: cancel / close',
    help_u: 'U: undo', help_m: 'M: mute', help_r: 'R: restart (confirm)', help_f: 'F: fullscreen', help_q: '? / /: this help', help_drag: 'Pieces are also draggable; drag can be disabled in settings.',
